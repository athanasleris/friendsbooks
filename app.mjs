...
const myBooksSession = session({
    ...
    store: new MemoryStore({ checkPeriod: 86400 * 1000 }),// 24 ωρες
    resave: false,
    saveUninitialized: false,
    name: "myBooks-sid", //αλλιώς connect.sid
    cookie: {
...
//διαβάζει το σώμα του αιτήματος απο μία φόρμα μεσω της μεθόδου post
